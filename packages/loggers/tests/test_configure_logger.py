...
def test_handler():
    ...
    try:
        ...
        # pass
        handler_controller.remove_handler("json")
        logger.removeHandler(handler_controller.handlers["json"])

        handler_controller.remove_handler("stream")
        logger.removeHandler(handler_controller.handlers["stream"])

        handler_controller.remove_handler("main")
        logger.removeHandler(handler_controller.handlers["main"])
...
class TestHandlerControler:
    ...
    def test_readable_log_file_creation(self, test_handler):
        ...
        log_controller = test_handler
        assert os.path.exists(log_controller.get_handler("main"))

    
    def test_add_new_run_name_logger(self, test_handler):
